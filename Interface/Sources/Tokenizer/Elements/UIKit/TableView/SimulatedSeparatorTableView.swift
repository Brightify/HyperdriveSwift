...
extension Module.UIKit {
    public class SimulatedSeparatorTableView: View, ComponentDefinitionContainer {
        ...
        public override func initialize(context: ReactantLiveUIWorker.Context) throws -> UIView {
            ...
            let tableView =  HyperdriveInterface.SimulatedSeparatorTableView<CellWrapper>(cellFactory: {
    ...
    public class SimulatedSeparatorTableViewProperties: PropertyContainer {
        public let separatorHeight: StaticAssignablePropertyDescription<Double>
