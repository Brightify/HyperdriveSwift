 ...
 */
public struct ElementControlStatePropertyDescription<T: TypedElementSupportedTypeFactory>: TypedPropertyDescription, ControlStatePropertyDescriptionMarker {
...
extension ElementControlStatePropertyDescription: ElementPropertyDescription where T: TypedElementSupportedTypeFactory {
