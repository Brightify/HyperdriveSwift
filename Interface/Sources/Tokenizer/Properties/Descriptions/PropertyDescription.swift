...
public protocol PropertyDescription {
    ...
    var anyTypeFactory: SupportedTypeFactory { get }
...
public protocol TypedPropertyDescription: PropertyDescription where ValueType == FactoryType.BuildType {
    associatedtype ValueType
    associatedtype FactoryType: TypedSupportedTypeFactory

    var defaultValue: ValueType { get }

    var typeFactory: FactoryType { get }
}
...
//    }
    ...
    public var anyTypeFactory: SupportedTypeFactory {
        return typeFactory
    }
...
public extension TypedPropertyDescription where ValueType: HasStaticTypeFactory, ValueType.TypeFactory == FactoryType {
    public var typeFactory: FactoryType {
        return ValueType.typeFactory
    }
}
