...
public struct EdgeInsets: TypedSupportedType, HasStaticTypeFactory {
...
extension EdgeInsets {
    public final class TypeFactory: TypedAttributeSupportedTypeFactory, HasZeroArgumentInitializer {
        public typealias BuildType = EdgeInsets
        ...
        public func typedMaterialize(from value: String) throws -> EdgeInsets {
        ...
        public func runtimeType(for platform: RuntimePlatform) -> RuntimeType {
            return RuntimeType(name: "UIEdgeInsets", module: "UIKit")
        }
    }
}
